...
- `jruby-9.1.16.0`
- `mvn-3.5.0+`
- `processing-3.3.7` jogl and gluegen jars (not ones from maven central, copy to lib folder) 
...
jgem install propane-3.0.0-java.pre.gem # local install requires a custom processing-core
```
